...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --arch=arm --enable-nonfree --enable-asm --cpu=cortex-a8 --cc='C:/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-gcc' --cross-prefix='C:/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-' --nm='C:/android-ndk-r9d/toolchains/arm-linux-androideabi-4.8/prebuilt/windows/bin/arm-linux-androideabi-nm' --sysroot='C:/android-ndk-r9d/platforms/android-9/arch-arm/' --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -mfloat-abi=softfp -marm -mcpu=cortex-a8 ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=C:/android-ndk-r9d/platforms/android-9/arch-arm//usr/lib -LC:/android-ndk-r9d/platforms/android-9/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog' --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-swscale --enable-swresample --enable-avformat --enable-avcodec --disable-optimizations --disable-debug --disable-doc --disable-stripping --enable-pthreads --disable-yasm --enable-zlib --enable-pic --enable-small"
